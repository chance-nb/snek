...
public abstract class SpaceGameObject extends Sprite {
    Main main;
     ...
     */
    public SpaceGameObject(Main main, Texture texture, float posx, float posy, float sizex, float sizey, float originx,
            float originy) {
        super(texture);
        this.main = main;
    ...
    public abstract void update(SpaceInvadersGameScreen parent, float delta);
